...
public interface Eventhub {
    ...
    /**
     * Gets the messageTimestampType property: Denotes the type of timestamp the message will hold. Two types of
    ...
    /**
     * Gets the identifier property: Denotes the unique identifier for event hub and is generated by service while
    ...
    /**
     * Gets the userMetadata property: Gets and Sets Metadata of User.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithMessageRetentionInDays, DefinitionStages.WithPartitionCount,
            ...
            DefinitionStages.WithRetentionDescription, DefinitionStages.WithMessageTimestampType,
        ...
        /**
         * The stage of the Eventhub definition allowing to specify messageTimestampType.
         */
        interface WithMessageTimestampType {
            /**
             * Specifies the messageTimestampType property: Denotes the type of timestamp the message will hold. Two
             * types of timestamp types AppendTime, CreateTime. AppendTime refers the time in which message got appended
             * inside broker log. CreateTime refers to the time in which the message was generated on source side and
             * producers can set this timestamp while sending the message. Default value is AppendTime. If you are using
             * AMQP protocol, CreateTime equals AppendTime for now and will full have runtime support later..
             * 
             * @param messageTimestampType Denotes the type of timestamp the message will hold. Two types of timestamp
             * types AppendTime, CreateTime. AppendTime refers the time in which message got appended inside broker log.
             * CreateTime refers to the time in which the message was generated on source side and producers can set
             * this timestamp while sending the message. Default value is AppendTime. If you are using AMQP protocol,
             * CreateTime equals AppendTime for now and will full have runtime support later.
             * @return the next definition stage.
             */
            WithCreate withMessageTimestampType(TimestampType messageTimestampType);
        }

        /**
         * The stage of the Eventhub definition allowing to specify userMetadata.
         */
        interface WithUserMetadata {
            /**
             * Specifies the userMetadata property: Gets and Sets Metadata of User..
             * 
             * @param userMetadata Gets and Sets Metadata of User.
             * @return the next definition stage.
             */
     ...
     */
    interface Update extends UpdateStages.WithMessageRetentionInDays, UpdateStages.WithPartitionCount,
        UpdateStages.WithStatus, UpdateStages.WithCaptureDescription, UpdateStages.WithRetentionDescription,
        UpdateStages.WithMessageTimestampType, UpdateStages.WithUserMetadata {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the Eventhub update allowing to specify messageTimestampType.
         */
        interface WithMessageTimestampType {
            /**
             * Specifies the messageTimestampType property: Denotes the type of timestamp the message will hold. Two
             ...
             * @return the next definition stage.
             */
            Update withMessageTimestampType(TimestampType messageTimestampType);
        }

        /**
         * The stage of the Eventhub update allowing to specify userMetadata.
         */
        interface WithUserMetadata {
            /**
             * Specifies the userMetadata property: Gets and Sets Metadata of User..
