...
public final class ConsumerGroupsClientImpl implements ConsumerGroupsClient {
    ...
    public interface ConsumerGroupsService {
        ...
        Mono<Response<ConsumerGroupInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") ConsumerGroupInner parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConsumerGroupInner>> get(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("namespaceName") String namespaceName,
            @PathParam("eventHubName") String eventHubName, @PathParam("consumerGroupName") String consumerGroupName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConsumerGroupListResult>> listByEventHub(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("namespaceName") String namespaceName,
    ...
    private Mono<Response<ConsumerGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, namespaceName,
                eventHubName, consumerGroupName, this.client.getApiVersion(), this.client.getSubscriptionId(),
    ...
    private Mono<Response<ConsumerGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, namespaceName, eventHubName,
            consumerGroupName, this.client.getApiVersion(), this.client.getSubscriptionId(), parameters, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConsumerGroupInner> createOrUpdateAsync(String resourceGroupName, String namespaceName,
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String namespaceName,
        ...
        return FluxUtil
            .withContext(
                context -> service.delete(this.client.getEndpoint(), resourceGroupName, namespaceName, eventHubName,
                    consumerGroupName, this.client.getApiVersion(), this.client.getSubscriptionId(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ConsumerGroupInner>> getWithResponseAsync(String resourceGroupName, String namespaceName,
        ...
        return FluxUtil
            .withContext(
                context -> service.get(this.client.getEndpoint(), resourceGroupName, namespaceName, eventHubName,
                    consumerGroupName, this.client.getApiVersion(), this.client.getSubscriptionId(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ConsumerGroupInner>> getWithResponseAsync(String resourceGroupName, String namespaceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), resourceGroupName, namespaceName, eventHubName, consumerGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConsumerGroupInner> getAsync(String resourceGroupName, String namespaceName, String eventHubName,
        String consumerGroupName) {
    ...
    private Mono<PagedResponse<ConsumerGroupInner>> listByEventHubSinglePageAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByEventHub(this.client.getEndpoint(), resourceGroupName, namespaceName,
                eventHubName, this.client.getApiVersion(), this.client.getSubscriptionId(), skip, top, accept, context))
    ...
    private Mono<PagedResponse<ConsumerGroupInner>> listByEventHubSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listByEventHub(this.client.getEndpoint(), resourceGroupName, namespaceName, eventHubName,
