...
public final class RegenerateAccessKeyParameters {
    ...
    /**
     * Get the key property: Optional, if the key value provided, is set for KeyType or autogenerated Key value set for keyType.
     * 
    ...
    /**
     * Set the key property: Optional, if the key value provided, is set for KeyType or autogenerated Key value set for keyType.
     * 
