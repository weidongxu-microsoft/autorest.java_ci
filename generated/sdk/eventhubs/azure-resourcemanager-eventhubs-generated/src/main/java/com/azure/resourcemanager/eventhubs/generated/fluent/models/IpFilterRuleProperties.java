...
@Fluent
public final class IpFilterRuleProperties {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(IpFilterRuleProperties.class);
     ...
     * @return the IpFilterRuleProperties object itself.
     */
    public IpFilterRuleProperties withIpMask(String ipMask) {
        this.ipMask = ipMask;
        return this;
    }
     ...
     * @return the IpFilterRuleProperties object itself.
     */
    public IpFilterRuleProperties withAction(IpAction action) {
        this.action = action;
        return this;
    }
     ...
     * @return the IpFilterRuleProperties object itself.
     */
    public IpFilterRuleProperties withFilterName(String filterName) {
