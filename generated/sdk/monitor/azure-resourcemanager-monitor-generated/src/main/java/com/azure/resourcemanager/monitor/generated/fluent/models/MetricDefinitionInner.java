        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isDimensionRequired".equals(fieldName)) {
                    ...
                    deserializedMetricDefinitionInner.name = LocalizableStringAutoGenerated.fromJson(reader);
                    ...
                    List<LocalizableStringAutoGenerated> dimensions
                        = reader.readArray(reader1 -> LocalizableStringAutoGenerated.fromJson(reader1));
