...
public final class AlertRulesClientImpl implements AlertRulesClient {
    ...
    /**
     * The interface defining all the services for MonitorClientAlertRules to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AlertRuleResourceInner> createOrUpdateAsync(String resourceGroupName, String ruleName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AlertRuleResourceInner> updateAsync(String resourceGroupName, String ruleName,
        AlertRuleResourcePatch alertRulesResource) {
