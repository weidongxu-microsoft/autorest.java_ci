...
public final class MetricsClientImpl implements MetricsClient {
    ...
    /**
     * The interface defining all the services for MonitorClientMetrics to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @param interval The interval (i.e. timegrain) of the query in ISO 8601 duration format. Defaults to PT1M. Special case for 'FULL' value that returns single datapoint for entire time span requested.
