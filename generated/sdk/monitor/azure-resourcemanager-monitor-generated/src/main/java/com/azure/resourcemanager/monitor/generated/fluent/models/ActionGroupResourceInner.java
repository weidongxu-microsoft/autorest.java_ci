        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ActionGroupResourceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ActionGroupResourceInner.class);
