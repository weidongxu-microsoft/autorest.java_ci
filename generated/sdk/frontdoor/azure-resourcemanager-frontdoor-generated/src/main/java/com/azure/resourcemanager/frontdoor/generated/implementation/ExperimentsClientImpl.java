...
import com.azure.resourcemanager.frontdoor.generated.models.ExperimentList;
...
public final class ExperimentsClientImpl implements ExperimentsClient {
    ...
    /**
     * The interface defining all the services for FrontDoorManagementClientExperiments to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface ExperimentsService {
        ...
        Mono<Response<ExperimentList>> listByProfile(@HostParam("$host") String endpoint,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return defines the properties of an Experiment along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
