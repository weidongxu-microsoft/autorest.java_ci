...
/**
 * Front Door represents a collection of backend endpoints to route traffic to along with rules that specify how
...
public final class FrontDoorInner extends Resource {
    ...
    /**
     * Get the enabledState property: Operational status of the Front Door load balancer. Permitted values are
     * 'Enabled' or 'Disabled'.
     * 
    ...
    /**
     * Set the enabledState property: Operational status of the Front Door load balancer. Permitted values are
     * 'Enabled' or 'Disabled'.
     * 
