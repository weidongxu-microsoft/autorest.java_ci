...
public final class FrontDoorNameAvailabilitiesClientImpl implements FrontDoorNameAvailabilitiesClient {
    private final ClientLogger logger = new ClientLogger(FrontDoorNameAvailabilitiesClientImpl.class);
    ...
    FrontDoorNameAvailabilitiesClientImpl(FrontDoorManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    FrontDoorNameAvailabilitiesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private Mono<Response<CheckNameAvailabilityOutputInner>> checkWithResponseAsync(
        ...
        return service
            .check(this.client.getEndpoint(), apiVersion, checkFrontDoorNameAvailabilityInput, accept, context);
    }
