        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model VirtualMachineRunCommandInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineRunCommandInner.class);
