        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ProximityPlacementGroupInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ProximityPlacementGroupInner.class);
