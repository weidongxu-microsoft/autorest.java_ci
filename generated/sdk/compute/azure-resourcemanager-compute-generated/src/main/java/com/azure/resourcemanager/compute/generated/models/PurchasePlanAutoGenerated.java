...
public final class PurchasePlanAutoGenerated {
    ...
    public void validate() {
        ...
        if (publisher() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property publisher in model PurchasePlanAutoGenerated"));
        }
        if (product() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property product in model PurchasePlanAutoGenerated"));
        }
    }
