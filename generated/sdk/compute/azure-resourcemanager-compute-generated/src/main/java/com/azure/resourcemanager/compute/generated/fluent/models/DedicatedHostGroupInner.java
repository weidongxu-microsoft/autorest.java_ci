        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model DedicatedHostGroupInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DedicatedHostGroupInner.class);
