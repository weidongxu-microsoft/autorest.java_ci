        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model GalleryApplicationInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(GalleryApplicationInner.class);
