...
public final class VirtualMachineScaleSetVMProfile {
    ...
    /**
     * Get the securityPostureReference property: Specifies the security posture to be used for all virtual machines in the scale set. Minimum api-version: 2023-03-01.
     * 
    ...
    /**
     * Set the securityPostureReference property: Specifies the security posture to be used for all virtual machines in the scale set. Minimum api-version: 2023-03-01.
     * 
    ...
    /**
     * Get the timeCreated property: Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. Minimum API version for this property is 2023-09-01. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile with minimum api-version 2023-09-01.
     * 
