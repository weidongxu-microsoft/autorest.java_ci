        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model VirtualMachineExtensionInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineExtensionInner.class);
