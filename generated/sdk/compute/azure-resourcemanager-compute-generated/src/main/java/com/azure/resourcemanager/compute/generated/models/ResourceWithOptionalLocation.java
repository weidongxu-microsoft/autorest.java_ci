        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ResourceWithOptionalLocation"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ResourceWithOptionalLocation.class);
