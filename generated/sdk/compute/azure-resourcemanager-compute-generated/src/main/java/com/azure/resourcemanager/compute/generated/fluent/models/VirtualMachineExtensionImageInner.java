        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model VirtualMachineExtensionImageInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(VirtualMachineExtensionImageInner.class);
