        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model RollingUpgradeStatusInfoInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(RollingUpgradeStatusInfoInner.class);
