        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model GalleryImageVersionInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(GalleryImageVersionInner.class);
