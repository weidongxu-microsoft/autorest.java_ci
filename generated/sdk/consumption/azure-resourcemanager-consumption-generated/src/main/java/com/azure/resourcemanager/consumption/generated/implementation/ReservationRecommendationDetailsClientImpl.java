...
public final class ReservationRecommendationDetailsClientImpl implements ReservationRecommendationDetailsClient {
    ...
    /**
     * The interface defining all the services for ConsumptionManagementClientReservationRecommendationDetails to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
