...
import com.azure.resourcemanager.consumption.generated.fluent.ChargesClient;
...
public final class ChargesClientImpl implements ChargesClient {
    ...
    /**
     * The interface defining all the services for ConsumptionManagementClientCharges to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
