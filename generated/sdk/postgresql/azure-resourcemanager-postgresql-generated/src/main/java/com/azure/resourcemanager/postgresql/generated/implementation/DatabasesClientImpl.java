...
import com.azure.resourcemanager.postgresql.generated.models.DatabaseListResult;
...
public final class DatabasesClientImpl implements DatabasesClient {
    ...
    /**
     * The interface defining all the services for PostgreSqlManagementClientDatabases to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
