...
public final class LocationBasedPerformanceTiersClientImpl implements LocationBasedPerformanceTiersClient {
    ...
    /**
     * The interface defining all the services for PostgreSqlManagementClientLocationBasedPerformanceTiers to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
