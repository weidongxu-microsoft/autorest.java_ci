...
import com.azure.resourcemanager.iothub.generated.fluent.OperationsClient;
...
import com.azure.resourcemanager.iothub.generated.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
    ...
    /**
     * The interface defining all the services for IotHubClientOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return result of the request to list IoT Hub operations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
     ...
     * @throws ErrorDetailsException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list IoT Hub operations as paginated response with {@link PagedFlux}.
     */
