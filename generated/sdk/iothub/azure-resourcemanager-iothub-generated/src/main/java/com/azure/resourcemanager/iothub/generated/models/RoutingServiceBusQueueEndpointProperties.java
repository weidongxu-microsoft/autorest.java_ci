...
public final class RoutingServiceBusQueueEndpointProperties
    ...
    /**
     * Reads an instance of RoutingServiceBusQueueEndpointProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RoutingServiceBusQueueEndpointProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RoutingServiceBusQueueEndpointProperties.
     */
    public static RoutingServiceBusQueueEndpointProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RoutingServiceBusQueueEndpointProperties deserializedRoutingServiceBusQueueEndpointProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    deserializedRoutingServiceBusQueueEndpointProperties.authenticationType
