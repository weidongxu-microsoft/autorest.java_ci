...
public interface LocalUsersOperations {
     ...
     */
    LocalUsers list(String resourceGroupName, String accountName);
     ...
     * @return list storage account local users.
     */
    Response<LocalUsers> listWithResponse(String resourceGroupName, String accountName, Context context);
