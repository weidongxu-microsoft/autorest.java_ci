...
public final class LocalUsersOperationsImpl implements LocalUsersOperations {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(LocalUsersOperationsImpl.class);
    ...
    public LocalUsers list(String resourceGroupName, String accountName) {
        LocalUsersInner inner = this.serviceClient().list(resourceGroupName, accountName);
        if (inner != null) {
            return new LocalUsersImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<LocalUsers> listWithResponse(String resourceGroupName, String accountName, Context context) {
        Response<LocalUsersInner> inner =
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new LocalUsersImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
