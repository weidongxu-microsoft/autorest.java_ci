...
public interface LocalUsersOperationsClient {
    ...
    LocalUsersInner list(String resourceGroupName, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<LocalUsersInner> listWithResponse(String resourceGroupName, String accountName, Context context);
