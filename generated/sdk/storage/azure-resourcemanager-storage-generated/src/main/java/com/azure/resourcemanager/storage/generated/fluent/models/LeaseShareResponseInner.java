...
public final class LeaseShareResponseInner {
    ...
    /**
     * Get the leaseId property: Returned unique lease ID that must be included with any request to delete the share,
    ...
    /**
     * Set the leaseId property: Returned unique lease ID that must be included with any request to delete the share,
     * or to renew, change, or release the lease.
     * 
