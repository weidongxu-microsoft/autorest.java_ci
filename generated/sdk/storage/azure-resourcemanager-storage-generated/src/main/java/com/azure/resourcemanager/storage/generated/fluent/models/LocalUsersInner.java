...
@Fluent
public final class LocalUsersInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(LocalUsersInner.class);
     ...
     * @return the LocalUsersInner object itself.
     */
    public LocalUsersInner withValue(List<LocalUserInner> value) {
        this.value = value;
        return this;
    }
