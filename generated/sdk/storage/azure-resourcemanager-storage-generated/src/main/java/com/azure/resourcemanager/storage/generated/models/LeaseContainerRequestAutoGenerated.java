...
@Fluent
public final class LeaseContainerRequestAutoGenerated {
    /*
     * Specifies the lease action. Can be one of the available actions.
     */
    @JsonProperty(value = "action", required = true)
    private LeaseContainerRequest action;
     ...
     */
    public LeaseContainerRequest action() {
        return this.action;
    }
     ...
     * @return the LeaseContainerRequestAutoGenerated object itself.
     */
    public LeaseContainerRequestAutoGenerated withAction(LeaseContainerRequest action) {
        this.action = action;
        return this;
    }
     ...
     * @return the LeaseContainerRequestAutoGenerated object itself.
     */
    public LeaseContainerRequestAutoGenerated withLeaseId(String leaseId) {
     ...
     * @return the LeaseContainerRequestAutoGenerated object itself.
     */
    public LeaseContainerRequestAutoGenerated withBreakPeriod(Integer breakPeriod) {
     ...
     * @return the LeaseContainerRequestAutoGenerated object itself.
     */
    public LeaseContainerRequestAutoGenerated withLeaseDuration(Integer leaseDuration) {
     ...
     * @return the LeaseContainerRequestAutoGenerated object itself.
     */
    public LeaseContainerRequestAutoGenerated withProposedLeaseId(String proposedLeaseId) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property action in model LeaseContainerRequestAutoGenerated"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(LeaseContainerRequestAutoGenerated.class);
}
