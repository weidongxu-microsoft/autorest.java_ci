...
public final class ManagementPoliciesClientImpl implements ManagementPoliciesClient {
    ...
    /**
     * The interface defining all the services for StorageManagementClientManagementPolicies to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return the managementpolicy associated with the specified storage account along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the managementpolicy associated with the specified storage account on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementPolicyInner> getAsync(String resourceGroupName, String accountName,
        ManagementPolicyName managementPolicyName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Get Storage Account ManagementPolicies operation response along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementPolicyInner> createOrUpdateAsync(String resourceGroupName, String accountName,
