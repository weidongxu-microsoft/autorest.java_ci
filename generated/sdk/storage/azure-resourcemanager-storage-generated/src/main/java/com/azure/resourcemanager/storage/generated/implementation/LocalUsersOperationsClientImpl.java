...
public final class LocalUsersOperationsClientImpl implements LocalUsersOperationsClient {
    ...
    private interface LocalUsersOperationsService {
        ...
        Mono<Response<LocalUsersInner>> list(
     ...
     * @return list storage account local users.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LocalUsersInner>> listWithResponseAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LocalUsersInner>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LocalUsersInner> listAsync(String resourceGroupName, String accountName) {
        return listWithResponseAsync(resourceGroupName, accountName)
            .flatMap(
                (Response<LocalUsersInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LocalUsersInner list(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LocalUsersInner> listWithResponse(String resourceGroupName, String accountName, Context context) {
