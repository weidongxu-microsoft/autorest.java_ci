...
import com.azure.resourcemanager.operationalinsights.generated.models.LinkedServiceListResult;
...
public final class LinkedServicesClientImpl implements LinkedServicesClient {
    ...
    /**
     * The interface defining all the services for OperationalInsightsManagementClientLinkedServices to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return the top level Linked service resource container along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the linked services instances in a workspace along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
