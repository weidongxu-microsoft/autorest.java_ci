...
import com.azure.resourcemanager.operationalinsights.generated.models.StorageInsightListResult;
...
public final class StorageInsightConfigsClientImpl implements StorageInsightConfigsClient {
    ...
    /**
     * The interface defining all the services for OperationalInsightsManagementClientStorageInsightConfigs to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return the top level storage insight resource container along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list storage insights operation response along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
