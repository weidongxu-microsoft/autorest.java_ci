...
import com.azure.resourcemanager.operationalinsights.generated.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
    ...
    /**
     * The interface defining all the services for OperationalInsightsManagementClientOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return result of the request to list solution operations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
