        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model GraphQueryResourceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(GraphQueryResourceInner.class);
