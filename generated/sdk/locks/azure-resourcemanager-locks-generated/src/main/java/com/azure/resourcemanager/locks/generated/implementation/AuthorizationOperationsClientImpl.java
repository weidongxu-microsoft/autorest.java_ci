...
import com.azure.resourcemanager.locks.generated.models.OperationListResult;
...
public final class AuthorizationOperationsClientImpl implements AuthorizationOperationsClient {
    ...
    /**
     * The interface defining all the services for ManagementLockClientAuthorizationOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return result of the request to list Microsoft.Authorization operations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Microsoft.Authorization operations as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Microsoft.Authorization operations as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
