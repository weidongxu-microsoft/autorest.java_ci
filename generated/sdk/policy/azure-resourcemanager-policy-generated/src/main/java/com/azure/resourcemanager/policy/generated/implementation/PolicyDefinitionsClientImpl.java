...
import com.azure.resourcemanager.policy.generated.models.PolicyDefinitionListResult;
...
public final class PolicyDefinitionsClientImpl implements PolicyDefinitionsClient {
    ...
    /**
     * The interface defining all the services for PolicyClientPolicyDefinitions to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PolicyDefinitionInner> createOrUpdateAtManagementGroupAsync(String policyDefinitionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAtManagementGroupAsync(String policyDefinitionName, String managementGroupId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PolicyDefinitionInner> getAtManagementGroupAsync(String policyDefinitionName,
        String managementGroupId) {
