...
public final class MhsmPrivateLinkResource extends ManagedHsmResource {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model MhsmPrivateLinkResource"));
        }
        if (sku() != null) {
            sku().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MhsmPrivateLinkResource.class);
