...
public final class ManagedHsmInner extends ManagedHsmResource {
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model ManagedHsmInner"));
        }
        if (sku() != null) {
            sku().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedHsmInner.class);
