...
public final class MhsmPrivateLinkResourcesClientImpl implements MhsmPrivateLinkResourcesClient {
    ...
    /**
     * The interface defining all the services for KeyVaultManagementClientMhsmPrivateLinkResources to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return the private link resources supported for the managed hsm pool along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MhsmPrivateLinkResourceListResultInner> listByMhsmResourceAsync(String resourceGroupName,
        String name) {
