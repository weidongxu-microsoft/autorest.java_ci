...
import com.azure.resourcemanager.mysql.generated.models.ServerBackupListResult;
...
public final class BackupsClientImpl implements BackupsClient {
    ...
    /**
     * The interface defining all the services for MySqlManagementClientBackups to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
