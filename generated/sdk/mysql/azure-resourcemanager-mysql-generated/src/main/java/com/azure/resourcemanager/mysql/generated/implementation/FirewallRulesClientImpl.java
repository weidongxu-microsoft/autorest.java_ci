...
import com.azure.resourcemanager.mysql.generated.models.FirewallRuleListResult;
...
public final class FirewallRulesClientImpl implements FirewallRulesClient {
    ...
    /**
     * The interface defining all the services for MySqlManagementClientFirewallRules to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
