...
import com.azure.resourcemanager.mysql.generated.models.LogFileListResult;
...
public final class LogFilesClientImpl implements LogFilesClient {
    ...
    /**
     * The interface defining all the services for MySqlManagementClientLogFiles to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
