...
import com.azure.resourcemanager.mysql.generated.models.DatabaseListResult;
...
public final class DatabasesClientImpl implements DatabasesClient {
    ...
    /**
     * The interface defining all the services for MySqlManagementClientDatabases to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
