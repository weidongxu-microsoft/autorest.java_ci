...
public interface RecordSets {
     ...
     */
    RecordSet update(String resourceGroupName, String zoneName, String relativeRecordSetName, RecordType recordType,
     ...
     * @return describes a DNS record set (a collection of DNS records with the same name and type).
     */
    RecordSet createOrUpdate(String resourceGroupName, String zoneName, String relativeRecordSetName,
     ...
     */
    Response<RecordSet> getWithResponse(String resourceGroupName, String zoneName, String relativeRecordSetName,
     ...
     * @return the response to a record set List operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RecordSet> listByType(String resourceGroupName, String zoneName, RecordType recordType, Integer top,
     ...
     * @return the response to a record set List operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RecordSet> listByDnsZone(String resourceGroupName, String zoneName, Integer top,
        String recordsetnamesuffix, Context context);
     ...
     * @return the response to a record set List operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RecordSet> listAllByDnsZone(String resourceGroupName, String zoneName, Integer top,
        String recordSetNameSuffix, Context context);
}
