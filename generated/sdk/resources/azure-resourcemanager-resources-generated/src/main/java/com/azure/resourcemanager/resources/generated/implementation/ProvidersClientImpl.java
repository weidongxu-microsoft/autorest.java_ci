...
public final class ProvidersClientImpl implements ProvidersClient {
    ...
    public interface ProvidersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ProviderListResult>> list(@HostParam("$host") String endpoint, @QueryParam("$top") Integer top,
        ...
        Mono<Response<ProviderListResult>> listAtTenantScope(@HostParam("$host") String endpoint,
            @QueryParam("$top") Integer top, @QueryParam("$expand") String expand,
    ...
    public ProviderInner register(String resourceProviderNamespace) {
        return registerWithResponse(resourceProviderNamespace, Context.NONE).getValue();
    }
    ...
    private Mono<PagedResponse<ProviderInner>> listSinglePageAsync(Integer top, String expand) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), top, expand, this.client.getApiVersion(),
                this.client.getSubscriptionId(), accept, context))
    ...
    private Mono<PagedResponse<ProviderInner>> listSinglePageAsync(Integer top, String expand, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), top, expand, this.client.getApiVersion(), this.client.getSubscriptionId(),
                accept, context)
    ...
    private PagedFlux<ProviderInner> listAsync(Integer top, String expand, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(top, expand, context),
    ...
    private Mono<PagedResponse<ProviderInner>> listAtTenantScopeSinglePageAsync(Integer top, String expand) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listAtTenantScope(this.client.getEndpoint(), top, expand,
    ...
    private PagedFlux<ProviderInner> listAtTenantScopeAsync(Integer top, String expand) {
        return new PagedFlux<>(() -> listAtTenantScopeSinglePageAsync(top, expand),
    ...
    private PagedFlux<ProviderInner> listAtTenantScopeAsync(Integer top, String expand, Context context) {
        return new PagedFlux<>(() -> listAtTenantScopeSinglePageAsync(top, expand, context),
