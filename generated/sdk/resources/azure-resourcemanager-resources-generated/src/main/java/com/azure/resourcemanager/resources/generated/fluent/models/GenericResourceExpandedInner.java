...
public final class GenericResourceExpandedInner extends GenericResourceInner {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model GenericResourceExpandedInner"));
        }
        if (plan() != null) {
            plan().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(GenericResourceExpandedInner.class);
