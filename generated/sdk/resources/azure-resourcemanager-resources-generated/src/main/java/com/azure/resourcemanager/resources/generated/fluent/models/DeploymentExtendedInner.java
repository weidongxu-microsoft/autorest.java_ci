        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model DeploymentExtendedInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DeploymentExtendedInner.class);
