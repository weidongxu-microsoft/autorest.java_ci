...
import com.azure.resourcemanager.databoxedge.generated.models.TriggerList;
...
public final class TriggersClientImpl implements TriggersClient {
    ...
    /**
     * The interface defining all the services for DataBoxEdgeManagementClientTriggers to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return collection of all trigger on the data box edge device along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
