...
import com.azure.resourcemanager.databoxedge.generated.models.OperationsList;
...
public final class OperationsClientImpl implements OperationsClient {
    ...
    /**
     * The interface defining all the services for DataBoxEdgeManagementClientOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return the list of operations used for the discovery of available provider operations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of operations used for the discovery of available provider operations as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of operations used for the discovery of available provider operations as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
