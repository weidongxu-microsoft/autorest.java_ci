        ...
        if (name() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property name in model RuntimeScriptActionDetailInner"));
        }
        if (uri() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property uri in model RuntimeScriptActionDetailInner"));
        }
        if (roles() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property roles in model RuntimeScriptActionDetailInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(RuntimeScriptActionDetailInner.class);
