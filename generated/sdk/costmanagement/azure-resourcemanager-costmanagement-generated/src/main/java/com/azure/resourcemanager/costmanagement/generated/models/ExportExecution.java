...
public final class ExportExecution extends ProxyResource {
    ...
    /**
     * Reads an instance of ExportExecution from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ExportExecution if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ExportExecution.
     */
    public static ExportExecution fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ExportExecution deserializedExportExecution = new ExportExecution();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedExportExecution.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedExportExecution.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedExportExecution.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedExportExecution.innerProperties = ExportExecutionProperties.fromJson(reader);
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedExportExecution.tags = tags;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedExportExecution;
        });
    }
}
