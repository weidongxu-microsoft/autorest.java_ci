...
public interface ForecastsClient {
    ...
    Response<QueryResultInner> usageWithResponse(String scope, ForecastDefinition parameters, String filter,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    QueryResultInner externalCloudProviderUsage(ExternalCloudProviderType externalCloudProviderType,
