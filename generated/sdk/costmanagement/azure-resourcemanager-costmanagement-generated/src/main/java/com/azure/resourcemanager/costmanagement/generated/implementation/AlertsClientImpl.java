...
import com.azure.resourcemanager.costmanagement.generated.fluent.AlertsClient;
import com.azure.resourcemanager.costmanagement.generated.fluent.models.AlertInner;
import com.azure.resourcemanager.costmanagement.generated.fluent.models.AlertsResultInner;
...
public final class AlertsClientImpl implements AlertsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AlertsResultInner> listWithResponse(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AlertInner> getWithResponse(String scope, String alertId) {
        return getWithResponseAsync(scope, alertId).block();
    }
    ...
    public Response<AlertInner> dismissWithResponse(String scope, String alertId, DismissAlertPayload parameters) {
        return dismissWithResponseAsync(scope, alertId, parameters).block();
    }
    ...
    public Response<AlertsResultInner> listExternalWithResponse(
        ExternalCloudProviderType externalCloudProviderType, String externalCloudProviderId) {
        return listExternalWithResponseAsync(externalCloudProviderType, externalCloudProviderId).block();
    }
