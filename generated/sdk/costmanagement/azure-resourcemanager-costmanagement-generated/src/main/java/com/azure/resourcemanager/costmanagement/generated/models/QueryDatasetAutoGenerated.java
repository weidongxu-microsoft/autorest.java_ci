 ...
 */
@Fluent
public final class QueryDatasetAutoGenerated implements JsonSerializable<QueryDatasetAutoGenerated> {
    /*
    ...
    /**
     * Creates an instance of QueryDatasetAutoGenerated class.
     */
    public QueryDatasetAutoGenerated() {
    }
     ...
     * @return the QueryDatasetAutoGenerated object itself.
     */
    public QueryDatasetAutoGenerated withAggregation(Map<String, QueryAggregation> aggregation) {
     ...
     * @return the QueryDatasetAutoGenerated object itself.
     */
    public QueryDatasetAutoGenerated withGrouping(List<QueryGrouping> grouping) {
    ...
    /**
     * Reads an instance of QueryDatasetAutoGenerated from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of QueryDatasetAutoGenerated if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the QueryDatasetAutoGenerated.
     */
    public static QueryDatasetAutoGenerated fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            QueryDatasetAutoGenerated deserializedQueryDatasetAutoGenerated = new QueryDatasetAutoGenerated();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("granularity".equals(fieldName)) {
                    deserializedQueryDatasetAutoGenerated.granularity = GranularityType.fromString(reader.getString());
                } else if ("configuration".equals(fieldName)) {
                    deserializedQueryDatasetAutoGenerated.configuration = QueryDatasetConfiguration.fromJson(reader);
                    ...
                    deserializedQueryDatasetAutoGenerated.aggregation = aggregation;
                } else if ("grouping".equals(fieldName)) {
                    List<QueryGrouping> grouping = reader.readArray(reader1 -> QueryGrouping.fromJson(reader1));
                    deserializedQueryDatasetAutoGenerated.grouping = grouping;
                } else if ("filter".equals(fieldName)) {
                    deserializedQueryDatasetAutoGenerated.filter = QueryFilterAutoGenerated.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedQueryDatasetAutoGenerated;
        });
    }
}
