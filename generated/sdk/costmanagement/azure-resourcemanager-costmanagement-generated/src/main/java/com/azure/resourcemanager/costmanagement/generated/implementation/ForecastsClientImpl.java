...
public final class ForecastsClientImpl implements ForecastsClient {
    ...
    /**
     * The interface defining all the services for CostManagementClientForecasts to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface ForecastsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<QueryResultInner>> externalCloudProviderUsage(@HostParam("$host") String endpoint,
            @QueryParam("$filter") String filter, @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<QueryResultInner>> usageWithResponseAsync(String scope, ForecastDefinition parameters,
        String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<QueryResultInner> externalCloudProviderUsageAsync(ExternalCloudProviderType externalCloudProviderType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public QueryResultInner externalCloudProviderUsage(ExternalCloudProviderType externalCloudProviderType,
        String externalCloudProviderId, ForecastDefinition parameters) {
        final String filter = null;
