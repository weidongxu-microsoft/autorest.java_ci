...
public final class ReportConfigDatasetConfiguration {
    ...
    /**
     * Get the columns property: Array of column names to be included in the report. Any valid report column name is allowed. If not provided, then report includes all columns.
     * 
    ...
    /**
     * Set the columns property: Array of column names to be included in the report. Any valid report column name is allowed. If not provided, then report includes all columns.
     * 
