...
public final class OperationsClientImpl implements OperationsClient {
    ...
    /**
     * The interface defining all the services for NetworkManagementClientOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return result of the request to list Network operations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
