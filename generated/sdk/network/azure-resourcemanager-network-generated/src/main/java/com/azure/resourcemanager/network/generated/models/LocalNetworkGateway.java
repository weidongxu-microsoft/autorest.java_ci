...
public interface LocalNetworkGateway {
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the LocalNetworkGateway definition which contains all the minimum required properties for the resource to be created, but also allows for any other optional properties to be specified.
         */
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithLocalNetworkAddressSpace,
            DefinitionStages.WithGatewayIpAddress, DefinitionStages.WithFqdn, DefinitionStages.WithBgpSettings {
            /**
