...
/**
 * Resource collection API of ServiceTagInformations.
 */
public interface ServiceTagInformations {
    /**
     ...
     * @return a list of service tag information resources with pagination as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ServiceTagInformation> list(String location, Boolean noAddressPrefixes, String tagName,
        Context context);
}
