...
public final class FirewallPolicyRuleCollectionGroupsImpl implements FirewallPolicyRuleCollectionGroups {
    ...
    public FirewallPolicyRuleCollectionGroupsImpl(FirewallPolicyRuleCollectionGroupsClient innerClient,
    ...
    public FirewallPolicyRuleCollectionGroup get(String resourceGroupName, String firewallPolicyName,
    ...
    public FirewallPolicyRuleCollectionGroup getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, Context.NONE)
            .getValue();
    }
