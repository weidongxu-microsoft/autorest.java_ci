...
public final class ServiceEndpointPolicyImpl
    ...
    public String serviceAlias() {
        return this.innerModel().serviceAlias();
    }

    public List<String> contextualServiceEndpointPolicies() {
        List<String> inner = this.innerModel().contextualServiceEndpointPolicies();
        if (inner != null) {
    ...
    ServiceEndpointPolicyImpl(ServiceEndpointPolicyInner innerObject,
    ...
    public ServiceEndpointPolicyImpl withServiceAlias(String serviceAlias) {
        this.innerModel().withServiceAlias(serviceAlias);
        return this;
    }

    public ServiceEndpointPolicyImpl
        withContextualServiceEndpointPolicies(List<String> contextualServiceEndpointPolicies) {
        this.innerModel().withContextualServiceEndpointPolicies(contextualServiceEndpointPolicies);
        return this;
    }
