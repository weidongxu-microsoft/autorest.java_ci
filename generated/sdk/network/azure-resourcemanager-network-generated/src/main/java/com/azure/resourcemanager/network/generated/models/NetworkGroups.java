...
/**
 * Resource collection API of NetworkGroups.
 */
public interface NetworkGroups {
    /**
     ...
     */
    Response<NetworkGroup> getWithResponse(String resourceGroupName, String networkManagerName, String networkGroupName,
        Context context);
     ...
     */
    PagedIterable<NetworkGroup> list(String resourceGroupName, String networkManagerName);
     ...
     * @return result of the request to list NetworkGroup as paginated response with {@link PagedIterable}.
     */
    PagedIterable<NetworkGroup> list(String resourceGroupName, String networkManagerName, Integer top, String skipToken,
        Context context);
     ...
     * @return the specified network group along with {@link Response}.
     */
    NetworkGroup getById(String id);
     ...
     * @return the specified network group along with {@link Response}.
     */
    Response<NetworkGroup> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new NetworkGroup resource.
     * 
     * @param name resource name.
     * @return the first stage of the new NetworkGroup definition.
     */
    NetworkGroup.DefinitionStages.Blank define(String name);
}
