...
/**
 * Resource collection API of AvailableEndpointServices.
 */
public interface AvailableEndpointServices {
     ...
     */
    PagedIterable<EndpointServiceResult> list(String location);
     ...
     * @return response for the ListAvailableEndpointServices API service call as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EndpointServiceResult> list(String location, Context context);
}
