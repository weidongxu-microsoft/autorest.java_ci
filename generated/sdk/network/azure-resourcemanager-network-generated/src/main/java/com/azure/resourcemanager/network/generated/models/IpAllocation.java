...
public interface IpAllocation {
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the IpAllocation definition which contains all the minimum required properties for the resource to be created, but also allows for any other optional properties to be specified.
         */
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithTypePropertiesType,
            DefinitionStages.WithPrefix, DefinitionStages.WithPrefixLength, DefinitionStages.WithPrefixType,
            DefinitionStages.WithIpamAllocationId, DefinitionStages.WithAllocationTags {
            /**
