...
import com.azure.resourcemanager.eventgrid.generated.models.DomainTopicsListResult;
...
public final class DomainTopicsClientImpl implements DomainTopicsClient {
    ...
    /**
     * The interface defining all the services for EventGridManagementClientDomainTopics to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the List Domain Topics operation along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
