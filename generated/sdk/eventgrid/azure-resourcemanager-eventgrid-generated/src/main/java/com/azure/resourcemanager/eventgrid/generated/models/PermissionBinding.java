...
public interface PermissionBinding {
    ...
    /**
     * Gets the topicSpaceName property: The name of the Topic Space resource that the permission is bound to. The Topic
    ...
    /**
     * Gets the clientGroupName property: The name of the client group resource that the permission is bound to. The
    ...
    /**
     * Gets the inner com.azure.resourcemanager.eventgrid.generated.fluent.models.PermissionBindingInner object.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithDescription,
                DefinitionStages.WithTopicSpaceName,
                DefinitionStages.WithPermission,
                DefinitionStages.WithClientGroupName {
            /**
        ...
        interface WithTopicSpaceName {
             ...
             * to. The Topic space needs to be a resource under the same namespace the permission binding is a part of..
             *
             * @param topicSpaceName The name of the Topic Space resource that the permission is bound to. The Topic
             *     space needs to be a resource under the same namespace the permission binding is a part of.
             * @return the next definition stage.
             */
        ...
        interface WithClientGroupName {
             ...
             * bound to. The client group needs to be a resource under the same namespace the permission binding is a
             * part of..
             *
             * @param clientGroupName The name of the client group resource that the permission is bound to. The client
             *     group needs to be a resource under the same namespace the permission binding is a part of.
             * @return the next definition stage.
             */
    ...
    interface Update
        extends UpdateStages.WithDescription,
            UpdateStages.WithTopicSpaceName,
            UpdateStages.WithPermission,
