...
import com.azure.resourcemanager.eventgrid.generated.models.NamespacesListResult;
...
public final class NamespacesClientImpl implements NamespacesClient {
    ...
    /**
     * The interface defining all the services for EventGridManagementClientNamespaces to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the List Namespaces operation along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
