...
import com.azure.resourcemanager.eventgrid.generated.models.PermissionBindingsListResult;
...
public final class PermissionBindingsClientImpl implements PermissionBindingsClient {
    ...
    PermissionBindingsClientImpl(EventGridManagementClientImpl client) {
        this.service =
            RestProxy.create(PermissionBindingsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface PermissionBindingsService {
        ...
        Mono<Response<PermissionBindingInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PermissionBindingsListResult>> listByNamespace(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("namespaceName") String namespaceName,
    ...
    private Mono<Response<PermissionBindingInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PermissionBindingInner> getAsync(
        String resourceGroupName, String namespaceName, String permissionBindingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PermissionBindingInner> getWithResponse(
        String resourceGroupName, String namespaceName, String permissionBindingName, Context context) {
    ...
    private PollerFlux<PollResult<PermissionBindingInner>, PermissionBindingInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<PermissionBindingInner, PermissionBindingInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<PermissionBindingInner>, PermissionBindingInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, namespaceName, permissionBindingName, permissionBindingInfo, context);
        return this
            .client
            .<PermissionBindingInner, PermissionBindingInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PermissionBindingInner> createOrUpdateAsync(
        String resourceGroupName,
        String namespaceName,
        String permissionBindingName,
        PermissionBindingInner permissionBindingInfo) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PermissionBindingInner createOrUpdate(
        String resourceGroupName,
        String namespaceName,
        String permissionBindingName,
        PermissionBindingInner permissionBindingInfo) {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String namespaceName, String permissionBindingName) {
        return beginDeleteAsync(resourceGroupName, namespaceName, permissionBindingName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String namespaceName, String permissionBindingName, Context context) {
        return beginDeleteAsync(resourceGroupName, namespaceName, permissionBindingName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PermissionBindingInner>> listByNamespaceSinglePageAsync(
                ...
                context ->
                    service
                        .listByNamespace(
                            ...
                            accept,
                            context))
            .<PagedResponse<PermissionBindingInner>>map(
                res ->
    ...
    private PagedFlux<PermissionBindingInner> listByNamespaceAsync(
        String resourceGroupName, String namespaceName, String filter, Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PermissionBindingInner> listByNamespace(
        String resourceGroupName, String namespaceName, String filter, Integer top, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PermissionBindingInner>> listByNamespaceNextSinglePageAsync(
