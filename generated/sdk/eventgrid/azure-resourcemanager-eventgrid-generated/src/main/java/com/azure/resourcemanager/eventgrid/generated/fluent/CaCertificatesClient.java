...
public interface CaCertificatesClient {
    ...
    Response<CaCertificateInner> getWithResponse(String resourceGroupName, String namespaceName,
    ...
    SyncPoller<PollResult<CaCertificateInner>, CaCertificateInner> beginCreateOrUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CaCertificateInner createOrUpdate(String resourceGroupName, String namespaceName, String caCertificateName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<CaCertificateInner> listByNamespace(String resourceGroupName, String namespaceName, String filter,
