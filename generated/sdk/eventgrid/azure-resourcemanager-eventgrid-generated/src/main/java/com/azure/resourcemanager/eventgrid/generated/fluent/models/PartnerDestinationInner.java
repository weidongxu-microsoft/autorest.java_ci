        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model PartnerDestinationInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(PartnerDestinationInner.class);
