        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model PartnerRegistrationInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(PartnerRegistrationInner.class);
