...
public final class PartnerRegistrationUpdateParameters
     ...
     * @return An instance of PartnerRegistrationUpdateParameters if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the PartnerRegistrationUpdateParameters.
     */
    public static PartnerRegistrationUpdateParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            PartnerRegistrationUpdateParameters deserializedPartnerRegistrationUpdateParameters
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("tags".equals(fieldName)) {
                    ...
                    deserializedPartnerRegistrationUpdateParameters.tags = tags;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedPartnerRegistrationUpdateParameters;
        });
    }
}
