...
public final class StorageConfigurationSettings implements JsonSerializable<StorageConfigurationSettings> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("enableStorageConfigBlade", this.enableStorageConfigBlade);
    ...
    public static StorageConfigurationSettings fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("enableStorageConfigBlade".equals(fieldName)) {
                    deserializedStorageConfigurationSettings.enableStorageConfigBlade
                        = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
