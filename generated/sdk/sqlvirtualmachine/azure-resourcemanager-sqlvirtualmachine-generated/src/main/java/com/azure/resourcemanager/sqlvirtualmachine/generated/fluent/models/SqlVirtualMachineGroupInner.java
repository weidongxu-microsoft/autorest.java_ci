        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model SqlVirtualMachineGroupInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SqlVirtualMachineGroupInner.class);
