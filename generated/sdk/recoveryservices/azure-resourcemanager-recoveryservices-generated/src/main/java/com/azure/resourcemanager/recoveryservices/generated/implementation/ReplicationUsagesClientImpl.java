...
import com.azure.resourcemanager.recoveryservices.generated.models.ReplicationUsageList;
...
public final class ReplicationUsagesClientImpl implements ReplicationUsagesClient {
    ...
    /**
     * The interface defining all the services for RecoveryServicesManagementClientReplicationUsages to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
