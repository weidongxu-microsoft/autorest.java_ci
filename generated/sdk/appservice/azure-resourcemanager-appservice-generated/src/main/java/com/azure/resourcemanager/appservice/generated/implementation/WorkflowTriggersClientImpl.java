...
public final class WorkflowTriggersClientImpl implements WorkflowTriggersClient {
    ...
    /**
     * The interface defining all the services for WebSiteManagementClientWorkflowTriggers to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the callback URL for a workflow trigger along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
