...
public final class StaticSiteLinkedBackendsCollection {
     ...
     */
    public StaticSiteLinkedBackendsCollection withValue(List<StaticSiteLinkedBackendArmResourceInner> value) {
        this.value = value;
        return this;
    }
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property value in model StaticSiteLinkedBackendsCollection"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(StaticSiteLinkedBackendsCollection.class);
}
