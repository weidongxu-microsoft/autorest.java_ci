    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model RequestHistoryInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(RequestHistoryInner.class);
