...
public final class WorkflowVersionsClientImpl implements WorkflowVersionsClient {
    ...
    /**
     * The interface defining all the services for WebSiteManagementClientWorkflowVersions to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    ...
    private Mono<PagedResponse<WorkflowVersionInner>> listSinglePageAsync(String resourceGroupName, String name,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, name, workflowName, this.client.getApiVersion(), top, accept, context))
    ...
    private Mono<Response<WorkflowVersionInner>> getWithResponseAsync(String resourceGroupName, String name,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, name, workflowName, versionId, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<WorkflowVersionInner>> getWithResponseAsync(String resourceGroupName, String name,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, name,
            workflowName, versionId, this.client.getApiVersion(), accept, context);
    }
