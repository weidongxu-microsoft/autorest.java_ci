...
public interface SiteAuthSettings {
    ...
    /**
     * Gets the googleClientId property: The OpenID Connect Client ID for the Google web application.
    ...
    /**
     * Gets the googleClientSecret property: The client secret associated with the Google web application.
     * This setting is required for enabling Google Sign-In.
     * Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/.
     * 
    ...
    /**
     * Gets the facebookAppId property: The App ID of the Facebook app used for login.
    ...
    /**
     * Gets the facebookAppSecret property: The App Secret of the Facebook app used for Facebook Login.
     * This setting is required for enabling Facebook Login.
     * Facebook Login documentation: https://developers.facebook.com/docs/facebook-login.
     * 
    ...
    /**
     * Gets the gitHubClientId property: The Client Id of the GitHub app used for login.
    ...
    /**
     * Gets the gitHubClientSecret property: The Client Secret of the GitHub app used for Github Login.
     * This setting is required for enabling Github login.
     * 
    ...
    /**
     * Gets the isAuthFromFile property: "true" if the auth config settings should be read from a file,
     * "false" otherwise.
     * 
    ...
    /**
     * Gets the authFilePath property: The path of the config file containing auth settings.
