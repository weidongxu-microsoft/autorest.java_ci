...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnection create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections()
            .createOrUpdateWithResponse(resourceGroupName, accountName, name, this.innerModel(), context).getValue();
        return this;
    }
    ...
    PrivateEndpointConnectionImpl(PrivateEndpointConnectionInner innerObject,
        ...
        this.name = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "privateEndpointConnections");
    }

    public PrivateEndpointConnection refresh() {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections()
            .getWithResponse(resourceGroupName, accountName, name, Context.NONE).getValue();
        return this;
    }

    public PrivateEndpointConnection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections()
            .getWithResponse(resourceGroupName, accountName, name, context).getValue();
        return this;
    }
