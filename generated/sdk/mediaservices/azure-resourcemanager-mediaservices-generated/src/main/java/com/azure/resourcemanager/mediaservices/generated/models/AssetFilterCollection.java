 ...
 */
@Fluent
public final class AssetFilterCollection implements JsonSerializable<AssetFilterCollection> {
    /*
     * A collection of AssetFilter items.
     */
    ...
    /**
     * Reads an instance of AssetFilterCollection from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AssetFilterCollection if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AssetFilterCollection.
     */
    public static AssetFilterCollection fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AssetFilterCollection deserializedAssetFilterCollection = new AssetFilterCollection();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    List<AssetFilterInner> value = reader.readArray(reader1 -> AssetFilterInner.fromJson(reader1));
                    deserializedAssetFilterCollection.value = value;
                } else if ("@odata.nextLink".equals(fieldName)) {
                    deserializedAssetFilterCollection.odataNextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAssetFilterCollection;
        });
    }
}
